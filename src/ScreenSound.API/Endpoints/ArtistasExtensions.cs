...
public static class ArtistasExtensions
{
    public static void AddEndPointsArtistas(this WebApplication app)
    {
        ...
        app.MapGet(
            "/Artistas/{nome}",
            ([FromServices] DAL<Artista> dal, string nome) =>
            {
        ...
        app.MapPost(
            ...
            ) =>
            {
                ...
                using var ms = new MemoryStream(
                    Convert.FromBase64String(artistaRequest.FotoPerfil!)
                );
        ...
        app.MapDelete(
            "/Artistas/{id}",
            ([FromServices] DAL<Artista> dal, int id) =>
            {
    ...
    private static ICollection<ArtistaResponse> EntityListToResponseList(
        IEnumerable<Artista> listaDeArtistas
    )
    {
