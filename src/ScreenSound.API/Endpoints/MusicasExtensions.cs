...
public static class MusicasExtensions
{
    public static void AddEndPointsMusicas(this WebApplication app)
    {
        ...
        app.MapGet(
            "/Musicas/{nome}",
            ([FromServices] DAL<Musica> dal, string nome) =>
            {
        ...
        app.MapDelete(
            "/Musicas/{id}",
            ([FromServices] DAL<Musica> dal, int id) =>
            {
        ...
        app.MapPut(
            "/Musicas",
            ([FromServices] DAL<Musica> dal, [FromBody] MusicaRequestEdit musicaRequestEdit) =>
            {
    ...
    private static ICollection<MusicaResponse> EntityListToResponseList(
        IEnumerable<Musica> musicaList
    )
    {
